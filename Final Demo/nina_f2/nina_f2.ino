...
void setup() {
  ...
  anglePID = {
    ...
    .Ki = 8,//7.3, //6
    .Kd = 0.15,//0.06, //0.08
    .TargetDefault = 1.18,//1.18 // target angle
    .OutputMax = 100,
...
// // Drive & turn implemented. Turn limited to 41. Drive limited to 50 cm (3820 encoder counts)
...
//       if(driveCommand != 0 && abs((driveEnc1 + driveEnc2)/2.0f) < 3400){
//         drivePID.Target = driveCommand;
//       } else {
//         drivePID.Target = 0.0;        
//       }
